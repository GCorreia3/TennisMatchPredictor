...
In Progress: Make a basic model which predicts which player wins based on who has a higher rank

Create an elo system and run through previous matches to create an elo for each player
